...
APP_NAME=${APP_NAME:-ISeeYou}
BUNDLE_ID=${BUNDLE_ID:-com.malpern.iseeyou}
...
<dict>
    ...
    <key>NSCameraUsageDescription</key><string>ISeeYou uses the camera to detect presence and attention. All processing happens on this Mac.</string>
</dict>
</plist>
PLIST
